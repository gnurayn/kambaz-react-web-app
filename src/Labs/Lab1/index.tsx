export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Nurayn Guru - CS4550 Fall 2025 Online Section </h2>
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        <div id="wd-h-tag">
          <h4>Heading Tags</h4>
...
to format vertical gaps between long pieces of text like 
this one.
  </p>
  <p id="wd-p-3">
This is the second paragraph. Even though there is a 
deliberate white gap between the paragraph above and 
this paragraph, by default browsers render them as one 
contiguous piece of text as shown here on the right.
  </p>
  <p id="wd-p-4">
This is the third paragraph. Wrap each paragraph with 
the paragraph tag to tell browsers to render the gaps.
  </p>
...
<div id="wd-lists">
  ...
  My favorite recipe (banana pudding):
...
<div id="wd-other-field-types">
<h4>Other HTML field types</h4>

<form id="wd-other-html-field-types">
...
Please &nbsp;
 <a href="https://github.com/gnurayn/kanbas-react-web-app" id="wd-github">click here</a>
